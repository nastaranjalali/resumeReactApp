    ...
    return (
        <Grid className={classes.root}>
            ...
            <Grid container direction={"row"}>
                ...
                <Grid xs={12} lg={6} className={classes.textContainer}>
                    <Typography variant={"h3"} style={{marginBottom: 15}}>
                        {translate.hi1}<span
                        className={classes.name}>{translate.name}</span>{translate.hi2}
                    </Typography>
                    <Typography variant={"body1"} className={classes.info} style={{marginBottom: 15}}>
                        {translate.homeDesc}
                    </Typography>
                    ...
                    <div style={{
                        display: "flex", marginTop: 25,
                            ...
                            <Button onClick={onDownload} variant="button" className={classes.cvButton}>
            ...
            <Grid container direction={"row"} className={classes.servicesContainer}>
                <Service title={translate.webDesign} desc={translate.designDesc}
                         icon={<PaletteIcon className={classes.icon}/>}/>
                <Service title={translate.webDevelopment} desc={translate.developDesc}
                         icon={<CodeIcon className={classes.icon}/>}/>
                <Service title={translate.mobileApplication} desc={translate.mobileAppDesc}
